...
{
    public static Dictionary<string, string> cartasCreadas = new Dictionary<string, string>();
    public static Dictionary<string, string> CartasCreadas => cartasCreadas;
    ...
    public Card(Expresion name, Expresion type, Expresion faction, Expresion power, List<Expresion> range, OnActivation onActivation, string Cuerpo) 
    {
        this.name = name;
        this.type = type;
    ...
    public override void Ejecutar()
    {
        ...
        int power = this.power is null? 0 : (int)this.power.Ejecutar();
            ...
            {
                case "Oro":
                    cartas.Add(new UnitCard(name, power, Faction, TipoDeCarta.Unit, zonas, Worth.Golden));
                    break;
                case "Plata":
                    cartas.Add(new UnitCard(name, power, Faction, TipoDeCarta.Unit, zonas, Worth.Silver));
                    break;
                case "Weather":
